...
VALUES ('1i', 'apartment', '-19.2761542656', '-136.6154386432', '735071', 'Llanquihue', 'Russian Federation'),
       ...
       ('16i', 'room', '66.8276508672', '-36.7207641088', '685635', 'Kollam', 'Netherlands');
...
UPDATE available
SET available = 1, price = 500
WHERE lid = '10i'
  and query_date >= '2022-01-01' AND query_date <='2022-10-10'
;

UPDATE available
SET available = 1, price = 600
WHERE lid = '11i'
  and query_date >= '2022-01-01' AND query_date <='2022-10-10'
;

UPDATE available
SET available = 1, price = 700
WHERE lid = '12i'
  and query_date >= '2022-01-01' AND query_date <='2022-10-10'
;

UPDATE available
SET available = 1, price = 800
WHERE lid = '13i'
  and query_date >= '2022-01-01' AND query_date <='2022-10-10'
;
UPDATE available
SET available = 1,price = 900
WHERE lid = '14i'
  and query_date >= '2022-01-01' AND query_date <='2022-10-10'
;
UPDATE available
